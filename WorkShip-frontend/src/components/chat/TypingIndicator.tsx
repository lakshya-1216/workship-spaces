export function TypingIndicator() {
  return (
    <div className="flex w-full justify-start animate-fade-in-up">
        <div className="flex items-center gap-1.5 rounded-tl-2xl rounded-tr-2xl rounded-br-2xl rounded-bl-sm bg-secondary px-4 py-3 w-fit shadow-[var(--shadow-soft)]">
